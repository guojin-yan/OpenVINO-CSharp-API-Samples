...
namespace blazeface_emgucv
{
    internal class Program
    {
        ...
        static void face_detection(string model_path, string image_path, string device)
        {
            ...
            //Cv2.WaitKey(0);
            Mat mat = new Mat();
            CvInvoke.Resize(image, mat, new Size(640, 640));
            ...
            for (int i = 0; i < result_len[0]; i++)
            {
                ...
                if (confidence > 0.5)
                {
                    ...
                    Rectangle box = new Rectangle((int)tlx, (int)tly, (int)(brx - tlx), (int)(bry - tly));
            ...
            for (int i = 0; i < position_boxes.Count; i++)
            {
                ...
                CvInvoke.PutText(image, confidences[index].ToString("0.00"),
                    new Point(position_boxes[index].Left, position_boxes[index].Top ),
                    FontFace.HersheySimplex, 0.4, new MCvScalar(255, 0, 0), 1);
            }
